		...
		<ScrollView className="flex-1 bg-white">
			...
			<View className="rounded-t-[40px] mt-[-40] bg-white p-[25] h-full flex-1 justify-between ">
				<View className="mt-6">
					...
					/>
					<Text
						onPress={() => myRouter.push("auth/Password-reset")}
						className="text-right mb-3 text-primary-300 text-sm"
					>
						Forgot password?
					</Text>
				</View>
				...
				>
					{isLoading ? (
						<ActivityIndicator
							className="bg-primary-300 rounded-full text-lg font-bold text-white text-center w-full py-3"
							size="small"
							color="white"
						/>
					) : (
